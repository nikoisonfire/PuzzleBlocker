...
export class LineSegment {
	...
	static compareLineSegments = function (segmentA, segmentB) {
	...
	projectedParameter = function (point) {
	...
	/* Returns true if the given point is on the segment, but is not equal to either
	 * of the endpoints */
	onSegmentIncludingEndpoints = function (point) {
		if (point.eq(this.point1) || point.eq(this.point2) || this.point1.eq(this.point2)) {
			return true;
		}
		/* Calculate twice the area of the triangle of the two segment points and the
	...
	intersectsOrientations = function (other) {
		...
		const orient1 = relativeOrientation(this.point1, this.point2, other.point1);
		const orient2 = relativeOrientation(this.point1, this.point2, other.point2);
		const orient3 = relativeOrientation(other.point1, other.point2, this.point1);
		const orient4 = relativeOrientation(other.point1, other.point2, this.point2);
	...
	intersectsIncludingSegment = function (other) {
