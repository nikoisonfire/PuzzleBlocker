...
export let InsideDirections = [];
export let SegmentDirections = [];
export let numOrientations = 8;
...
export const FlipDirections = [[new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(-6, 0)), /* 0 */
